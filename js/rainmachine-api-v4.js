...
function _API(async) {
    ...
    //var host = "127.0.0.1";
    //var host = "192.168.12.72"; //Example: A local networked RainMachine
    ...
    //var port = "8081"; //Example: Port for local network connection to a RainMachine
    ...
    function rest(type, apiCall, data, isBinary, extraHeaders, asyncObject, isAbsoluteUrl, noParse) {
        ...
        url += apiCall
        if (token !== null) { url += "?access_token=" + token };
    ...
    this.post = function(apiCall, data) { return rest("POST", apiCall, data, false, null, null, false); }
    this.get = function(apiCall) { return rest("GET", apiCall, null, false, null, null, false); }

    this.getEx = function(apiCall, noParse) { return rest("GET", apiCall, null, false, null, null, true, noParse); }
    this.postEx = function(apiCall, data, noParse) { return rest("POST", apiCall, data, false, null, null, true, noParse); }

    this.uploadFile = function(apiCall, data, extraHeaders) { return rest("POST", apiCall, data, true, extraHeaders, null, false); }
