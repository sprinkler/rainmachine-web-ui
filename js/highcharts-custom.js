/**
 * @license Highcharts 4.1.5 JS v/Highstock 2.1.5 (2015-04-13)
 *
...
var UNDEFINED,
	...
	charts = [],
	chartCount = 0,
	PRODUCT = 'Highcharts 4.1.5',
	VERSION = '/Highstock 2.1.5',
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com@product.cdnpath@//Highstock 2.1.5/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com@product.cdnpath@//Highstock 2.1.5/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
