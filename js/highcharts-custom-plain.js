/**
 * @license Highcharts 4.1.7 JS v/Highstock 2.1.7 (2015-06-26)
 *
...
var UNDEFINED,
	...
	charts = [],
	chartCount = 0,
	PRODUCT = 'Highcharts 4.1.7',
	VERSION = '/Highstock 2.1.7',
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com@product.cdnpath@//Highstock 2.1.7/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com@product.cdnpath@//Highstock 2.1.7/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
